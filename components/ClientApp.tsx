...
export function DistributionClient(){
 ...
 <YouTubeStudio episodes={store.episodes} onUploaded={(epId,url)=>setStore(s=>({...s,episodes:s.episodes.map(e=>e.id===epId?{...e,youtubeUrl:url}:e)}))} />
