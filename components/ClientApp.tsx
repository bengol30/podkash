...
export function EpisodesClient() {
  ...
  useEffect(() => { fetch('/api/all-episodes', { cache: 'no-store' }).then(r => r.ok ? r.json() : { episodes: [] }).then(d => setHostEpisodes(d.episodes || [])).catch(() => {}); }, []);
